...
//add
NK_API void                     nk_value_float_e(struct nk_context*, const char *prefix, float);
#endif
...
//add
NK_API void
nk_value_float_e(struct nk_context *ctx, const char *prefix, float value)
{nk_labelf(ctx, NK_TEXT_LEFT, "%s: %.3e", prefix, value);}
