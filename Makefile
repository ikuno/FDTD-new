all:
	...
	g++ -o fdtd main.cpp Camera.cpp Program.cpp Shader.cpp -I./nuklear -I./glm -lglfw3 -lGLEW -lGL -lXrandr -lXinerama -lXcursor -lXi -lXxf86vm -lX11 -lpthread -lrt -lm -std=c++11 -g  -fno-use-linker-plugin -Wall 
